...
import '../../model/withdrawHistoryModel.dart';
import '../../services/FirebaseHelper.dart';
import '../../services/helper.dart';
import '../../services/paypalclientToken.dart';
import '../../services/paystack_url_genrater.dart';
import '../../services/rozorpayConroller.dart';
import '../topup/TopUpScreen.dart';
...
import '../../model/paypalPaymentSettle.dart' as payPalSettel;
import '../../model/PayPalCurrencyCodeErrorModel.dart' as payPalCurrModel;
                        ...
                        if (_globalKeywithdraw.currentState!.validate()) {
                          ...
                          if (double.parse(minimumAmountToWithdrawal) >
                            ...
                            showAlertDialog(
                                context,
                                "Failed!".tr(),
                                'Withdraw amount must be greater or equal to $symbol${double.parse(minimumAmountToWithdrawal).toStringAsFixed(decimal)}'
                                    .tr(),
                                true);
                          } else {
                            withdrawRequest();
